...
for details in data_details:
	...
	ciudad = next((ciudad for ciudad in data_list if ciudad['id'] == details_id),
	 None)
	
	if ciudad:
		wheater_api[details_id] = {
...
#save to json file
with open('wheater_api.json', 'w') as json_file:
	json.dump(wheater_api, json_file, indent=4)
